...
import { Home, Plus, Settings, Cpu, BookOpen } from "lucide-react";
...
const BottomNav = () => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute left-4 top-1/2 -translate-y-1/2 hidden lg:flex items-center gap-2 text-neutral-700">
        <Cpu size={18} />
